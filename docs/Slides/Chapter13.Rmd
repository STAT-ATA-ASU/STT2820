...
On September, 11, 2002, a particular state lottery's daily number cane up 9-1-1.  Assume that no more than one digit is used to represent the first nine months.  Answer the following:
...
$$P(\text{not all 3s}) = 1 - P(\text{all 3s}) = 1 - (1/6)^3 = `r  - (1/6)^3`$$
