...
In experiments, out explanatory variables are called **factors** and the outcomes are measured by **response variables**.  The different values a factor can have are called **levels**.  **levels $\times$ levels = total treatments**.
