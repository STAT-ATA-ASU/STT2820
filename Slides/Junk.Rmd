...
- Three
- Four 
- Five --- No I am going to write right through the image!
...
---
background-image: url("https://raw.githubusercontent.com/alanarnholt/alanarnholt.github.io/master/images/Alan.png")
...
library(leaflet)
leaflet() %>% addTiles() %>% setView(lng=-81.684954, lat=36.216777, zoom = 17) %>% 
